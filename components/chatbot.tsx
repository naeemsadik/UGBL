...
const botTranslations: Record<string, Record<string, string>> = {
  EN: {
    ...
    welcome: "Hello! I am your River Tyne Assistant. How can I help you today? Ask me about our services, offices, portfolio, port specifications, or team!",
    noMatch: "I'm sorry, I couldn't find a perfect match. I only answer questions related to our company, services, ports, team, and projects. Feel free to use the quick action suggestions below or ask a different question!",
  ...
  ES: {
    ...
    welcome: "¡Hola! Soy su asistente virtual de River Tyne. ¿Cómo le puedo ayudar hoy? ¡Consúlteme sobre nuestros servicios, oficinas, portafolio, especificaciones de puertos o equipo!",
    noMatch: "Lo siento, no pude encontrar una coincidencia exacta. Solo respondo preguntas relacionadas con nuestra empresa, servicios, puertos, equipo y proyectos. ¡No dude en usar las sugerencias a continuación!",
  ...
  ZH: {
    ...
    welcome: "您好！我是您的 River Tyne 虚拟助手。今天我能为您做些什么？您可以询问有关我们的服务、办事处、投资组合、港口规范或团队的信息！",
    noMatch: "抱歉，我找不到完全匹配的答案。我只回答与我们的公司、服务、港口、团队和项目相关的问题。请随时使用下面的快捷建议或换个方式提问！",
    suggestedTitle: "推荐问题：",
  },
  BN: {
    ...
    welcome: "হ্যালো! আমি আপনার রিভার টাইন সহকারী। আজ আপনাকে কীভাবে সাহায্য করতে পারি? আমাদের পরিষেবা, অফিস, পোর্টফোলিও, পোর্টের বিবরণ বা দল সম্পর্কে জিজ্ঞাসা করুন!",
    noMatch: "দুঃখিত, আমি কোনো মিল খুঁজে পাইনি। আমি শুধুমাত্র আমাদের কোম্পানি, পরিষেবা, পোর্ট, দল এবং প্রকল্প সম্পর্কিত প্রশ্নের উত্তর দিই। নিচের প্রস্তাবিত প্রশ্নগুলো ব্যবহার করতে পারেন!",
    suggestedTitle: "প্রস্তাবিত প্রশ্নাবলী:",
  }
};

// Suggested questions mapping per language
const suggestedQuestions: Record<string, { label: string; question: string }[]> = {
  EN: [
...
const intents = [
  {
    id: "about",
    keywords: {
      EN: ["about", "company", "who are you", "who we are", "vision", "mission", "philosophy", "history", "background", "founded", "established", "fazesoft", "river tyne", "management", "leadership", "corporate"],
      ES: ["sobre", "nosotros", "quiénes somos", "quienes somos", "vision", "mision", "historia", "empresa", "compañia", "quien eres", "liderazgo"],
      ZH: ["关于", "公司", "你是谁", "我们是谁", "愿景", "使命", "历史", "背景", "创立", "成立", "领导"],
      BN: ["সম্পর্কে", "কোম্পানি", "কে তোমরা", "আমাদের সম্পর্কে", "ভিশন", "মিশন", "ইতিহাস", "পটভূমি", "প্রতিষ্ঠিত", "নেতৃত্ব"]
    }
  },
  {
    id: "services",
    keywords: {
      EN: ["services", "service", "offer", "provide", "do you do", "build", "solution", "agency", "chartering", "logistics", "husbandry", "brokering", "shipment", "cargo", "towing", "shifting", "delivery", "vessels", "commodity", "stevedoring", "clearance"],
      ES: ["servicios", "servicio", "ofrecen", "proveen", "hacen", "soluciones", "agencia", "fletamento", "logística", "aprovisionamiento", "corretaje", "carga", "remolque"],
      ZH: ["服务", "提供", "做些什么", "解决方案", "代理", "租船", "物流", "供应", "经纪", "货物", "驳运"],
      BN: ["সেবা", "সার্ভিস", "প্রদান", "করো", "সমাধান", "এজেন্সি", "চার্টারিং", "লজিস্টিকস", "হাজব্যান্ড্রি", "ব্রোকারিং", "পণ্য", "পরিবহন"]
    }
  },
  {
    id: "portfolio",
    keywords: {
      EN: ["portfolio", "project", "work", "case study", "what projects", "experience", "recent projects", "what have you done", "assignments", "delivering", "delivered", "coal vessel", "multi-port", "charter execution", "industrial cargo"],
      ES: ["portafolio", "proyecto", "trabajo", "caso de estudio", "qué proyectos", "experiencia", "proyectos recientes", "qué han hecho", "tareas", "carbón"],
      ZH: ["投资组合", "项目", "工作", "案例", "做过什么", "经验", "近期项目", "任务", "交付", "煤炭"],
      BN: ["পোর্টফোলিও", "প্রজেক্ট", "কাজ", "কেস স্টাডি", "কি প্রজেক্ট", "অভিজ্ঞতা", "সাম্প্রতিক প্রজেক্ট", "কি করেছেন", "অ্যাসাইনমেন্ট", "কয়লা"]
    }
  },
  {
    id: "contact",
    keywords: {
      EN: ["contact", "phone", "email", "address", "location", "office", "dhaka", "write to", "reach", "call", "hotline", "mobile", "number", "where are you", "head office", "gulshan"],
      ES: ["contacto", "teléfono", "correo", "dirección", "ubicación", "oficina", "dónde están", "llamar", "número", "dhaka"],
      ZH: ["联系", "电话", "邮箱", "地址", "位置", "办公室", "写信", "联系方式", "号码", "在哪", "达卡"],
      BN: ["যোগাযোগ", "ফোন", "ইমেইল", "ঠিকানা", "অবস্থান", "অফিস", "ঢাকা", "মোবাইল", "নম্বর", "কোথায় আছেন", "গুলশান"]
    }
  },
  {
    id: "ports",
    keywords: {
      EN: ["port", "ports", "chattogram", "chittagong", "matarbari", "mongla", "payra", "draft", "loa", "berth", "anchorage", "depth", "water", "density", "jetty", "restrictions", "kutubdia", "harbaria", "rabnabad", "dwt", "lng"],
      ES: ["puerto", "puertos", "chattogram", "chittagong", "matarbari", "mongla", "payra", "calado", "eslora", "muelle", "anclaje", "restricciones", "profundidad"],
      ZH: ["港口", "吉大港", "马塔巴里", "蒙格拉", "派拉", "吃水", "船长", "泊位", "锚地", "水深", "限制", "码头"],
      BN: ["পোর্ট", "বন্দর", "চট্টগ্রাম", "মাতারবাড়ি", "মংলা", "পায়রা", "ড্রাফট", "এলওএ", "জেটি", "অ্যাংকরেজ", "সীমাবদ্ধতা", "কুতুবদিয়া", "হারবাড়িয়া"]
    }
  },
  {
    id: "team",
    keywords: {
      EN: ["team", "people", "staff", "management", "directors", "abdul karim", "sadia", "rezaul", "fahim", "leadership", "who runs", "member", "managing director", "operations manager"],
      ES: ["equipo", "gente", "personal", "dirección", "directores", "liderazgo", "quién dirige", "miembro", "abdul", "sadia"],
      ZH: ["团队", "人员", "员工", "管理层", "董事", "领导力", "谁管理", "成员", "阿卜杜勒", "萨迪亚"],
      BN: ["দল", "কর্মী", "স্টাফ", "ব্যবস্থাপনা", "পরিচালক", "নেতৃত্ব", "কারা আছে", "সদস্য", "আবদুল করিম", "সাদিয়া"]
    }
  },
  {
    id: "pricing",
    keywords: {
      EN: ["price", "cost", "pricing", "charge", "fee", "rate", "package", "starter", "growth", "scale", "custom price"],
      ES: ["precio", "costo", "precios", "tarifa", "tasa", "paquete", "inicial", "crecimiento", "escala"],
      ZH: ["价格", "成本", "定价", "收费", "费用", "套餐", "初创", "增长", "扩展"],
      BN: ["মূল্য", "খরচ", "দাম", "চার্জ", "ফি", "প্যাকেজ", "স্টার্টার", "গ্রোথ", "স্কেল"]
    }
  },
  {
    id: "faq",
    keywords: {
      EN: ["faq", "question", "common query", "common questions", "frequently", "help", "support", "answers"],
      ES: ["faq", "pregunta", "preguntas frecuentes", "ayuda", "soporte", "respuestas"],
      ZH: ["常见问题", "问题", "帮助", "支持", "解答"],
      BN: ["প্রশ্নাবলী", "জিজ্ঞাসা", "সাধারণ প্রশ্ন", "সাহায্য", "সহায়তা", "উত্তর"]
    }
  }
];
...
export function Chatbot() {
  ...
  useEffect(() => {
    if (messages.length <= 1) {
      const welcomeMsg = botTranslations[locale]?.welcome || botTranslations.EN.welcome;
      const initialWelcome: Message = {
        id: "welcome",
        sender: "bot",
        text: welcomeMsg,
        timestamp: Date.now(),
        suggestions: suggestedQuestions[locale]?.map(q => q.question) || suggestedQuestions.EN.map(q => q.question)
      };
  ...
  const generateBotReply = (intentId: string | null, cleanedText: string): Omit<Message, "id" | "timestamp"> => {
    ...
    if (intentId === "services") {
      ...
      if (cleanedText.includes("port agency") || cleanedText.includes("protecting") || cleanedText.includes("opa") || cleanedText.includes("cpa")) {
        return {
          sender: "bot",
          text: `**${t("service.portAgency.title")}**\n${t("service.portAgency.subtitle")}\n\n${t("service.portAgency.overview")}\n\n${t("service.portAgency.secContent")}`,
          links: [{ label: t("service.portAgency.title"), href: "/services/port-agency" }],
          suggestions: ["Husbandry services", "Logistics services", "Brokering services", "Show all services"]
        };
      }
      if (cleanedText.includes("husbandry")) {
        return {
          ...
          links: [{ label: t("service.husbandry.title"), href: "/services/husbandry-agency" }],
          suggestions: ["Port agency services", "Logistics services", "Show all services"]
        };
      }
      if (cleanedText.includes("logistics") || cleanedText.includes("transport") || cleanedText.includes("warehouse")) {
        return {
          sender: "bot",
          text: `**${t("service.logistics.title")}**\n${t("service.logistics.subtitle")}\n\n${t("service.logistics.overview")}`,
          links: [{ label: t("service.logistics.title"), href: "/services/logistics-agency" }],
          suggestions: ["Husbandry services", "Brokering services", "Show all services"]
        };
      }
      if (cleanedText.includes("brokering") || cleanedText.includes("charter")) {
        return {
          sender: "bot",
          text: `**${t("services.brokering")}**\n${t("services.brokeringDesc")}\n\n${t("home.charteringServicesDesc")}`,
          links: [{ label: t("services.brokering"), href: "/services/brokering" }],
          suggestions: ["Port agency services", "Logistics services", "Show all services"]
        };
      }
      ...
      return {
        ...
        suggestions: ["Tell me about Port Agency", "Tell me about Husbandry", "Tell me about Logistics", "Show portfolio"]
      };
    }
    ...
    if (intentId === "contact") {
      return {
        ...
        suggestions: ["Where are your offices?", "About company", "Common FAQs"]
      };
    }

    if (intentId === "ports") {
      // Specific ports check
      if (cleanedText.includes("chattogram") || cleanedText.includes("chittagong")) {
        ...
        return {
          ...
          links: [{ label: t("portInfo.chattogram"), href: "/port-info/chattogram" }],
          suggestions: ["Matarbari Port info", "Mongla Port info", "Payra Port info", "Show all ports"]
        };
      }
      if (cleanedText.includes("matarbari")) {
        return {
          ...
          links: [{ label: t("portInfo.matarbari"), href: "/port-info/matarbari" }],
          suggestions: ["Chattogram Port info", "Mongla Port info", "Payra Port info", "Show all ports"]
        };
      }
      if (cleanedText.includes("mongla")) {
        return {
          ...
          suggestions: ["Chattogram Port info", "Matarbari Port info", "Payra Port info", "Show all ports"]
        };
      }
      if (cleanedText.includes("payra")) {
        return {
          ...
          suggestions: ["Chattogram Port info", "Matarbari Port info", "Mongla Port info", "Show all ports"]
        };
      }
      ...
      return {
        ...
        suggestions: ["Chattogram Port info", "Matarbari Port info", "Mongla Port info", "Payra Port info"]
      };
    }
    ...
    if (intentId === "team") {
      return {
        ...
        suggestions: ["About company", "Contact information", "What services do you provide?"]
      };
    }
    ...
    if (intentId === "faq") {
      return {
        ...
        suggestions: ["What services do you provide?", "What ports do you cover?", "Contact information"]
      };
    }
  ...
  const formatMessageText = (text: string) => {
    ...
    return lines.map((line, idx) => {
      ...
      if (isBullet) {
        return (
          <li key={idx} className="ml-4 list-disc mb-1 text-sm text-[#4a586d] leading-relaxed">
            {parts}
          </li>
        );
      }
      ...
      if (line.startsWith("**") && line.endsWith("**")) {
        return (
          <h4 key={idx} className="font-bold text-[#1D2E54] text-sm mt-3 mb-1 first:mt-0">
            {parts}
          </h4>
        );
      }
      ...
      return (
        <p key={idx} className="mb-2 text-sm text-[#4a586d] leading-relaxed last:mb-0">
          {parts}
        </p>
      );
    });
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
        ...
        >
          ...
          <div className="flex items-center justify-between bg-[#1D2E54] px-4 py-3.5 text-white">
            <div className="flex items-center gap-2.5">
              <div className="relative flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-tr from-[#49A98F] to-[#79C9A1] shadow-inner">
                <Sparkles className="h-4.5 w-4.5 text-[#1D2E54]" />
              </div>
              <div>
                <h3 className="text-sm font-semibold tracking-wide">{currentT.title}</h3>
            ...
            {messages.map((msg) => (
              <div
                ...
                className={`flex w-full flex-col ${
                  msg.sender === "user" ? "items-end animate-in slide-in-from-right-3 fade-in" : "items-start animate-in slide-in-from-left-3 fade-in"
                }`}
              >
                {/* Bubble Container */}
                <div
          ...
          {/* Form Input Panel */}
          <form onSubmit={handleSend} className="border-t border-slate-100 bg-white p-3.5">
      ...
      <button
        onClick={toggleChat}
        className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-tr from-[#1D2E54] to-[#49A98F] text-white shadow-xl hover:scale-105 active:scale-95 hover:rotate-[6deg] transition-all duration-300 cursor-pointer"
      >
        {isOpen ? (
          <X className="h-6 w-6 transition-transform duration-300 rotate-0" />
        ) : (
          <MessageSquare className="h-6 w-6 transition-transform duration-300 hover:scale-110" />
        )}
